================================================================================
    MICROSOFT FOUNDATION CLASS ライブラリ : DiamondCursor プロジェクトの概要
===============================================================================



    アプリケーション ウィザードが作成した DiamondCursor には Microsoft 
    Foundation Classes の基本的な使い方が示されています。アプリケーション作成のひな型としてお使い
    ください。
    このファイルには DiamondCursor アプリケーションを構成している各ファイルの概要説明が含
    まれています。

DiamondCursor.vcproj
...
DiamondCursor.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CDiamondCursorApp アプリケーション クラス
    の宣言をします。

DiamondCursor.cpp
    このファイルは CDiamondCursorApp アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\DiamondCursor.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイルです。このアイコンは
    リソース ファイル DiamondCursor.rc によってインクルードされます。

res\DiamondCursor.rc2
...
DiamondCursorDlg.h, DiamondCursorDlg.cpp - the dialog
    Tこれらのファイルは CDiamondCursorDlg クラスを含みます。このクラスはアプリケーションの 
    メイン ダイアログの動作を定義します。ダイアログ テンプレートは Microsoft Visual C++ で編集 
    可能な DiamondCursor.rc に含まれます。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) DiamondCursor.pch や既にコン 
