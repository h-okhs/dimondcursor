========================================================================
    MICROSOFT FOUNDATION CLASS ライブラリ : KBHookDLL プロジェクトの概要
========================================================================


AppWizard はユーザー用に KBHookDLL DLL を作成しました。この DLL ファイルには 
Microsoft Foundation Classes の基本的な使い方が示されています。
アプリケーション作成のひな型としてお使いください。

このファイルには KBHookDLL DLL を構成している
各ファイルの概要説明が含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダー (PCH) ファイル KBHookDLL.pch、
