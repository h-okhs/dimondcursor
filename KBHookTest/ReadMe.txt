================================================================================
    MICROSOFT FOUNDATION CLASS ライブラリ : KBHookTest プロジェクトの概要
===============================================================================



    アプリケーション ウィザードが作成した KBHookTest には Microsoft 
    Foundation Classes の基本的な使い方が示されています。アプリケーション作成のひな型としてお使い
    ください。
    このファイルには KBHookTest アプリケーションを構成している各ファイルの概要説明が含
    まれています。
...
KBHookTest.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CKBHookTestApp アプリケーション クラス
    の宣言をします。

KBHookTest.cpp
    このファイルは CKBHookTestApp アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\KBHookTest.ico
    ...
    リソース ファイル KBHookTest.rc によってインクルードされます。
...
KBHookTestDlg.h, KBHookTestDlg.cpp - the dialog
    Tこれらのファイルは CKBHookTestDlg クラスを含みます。このクラスはアプリケーションの 
    メイン ダイアログの動作を定義します。ダイアログ テンプレートは Microsoft Visual C++ で編集 
    可能な KBHookTest.rc に含まれます。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) KBHookTest.pch や既にコン 
